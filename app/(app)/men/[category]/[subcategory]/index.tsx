...
import ProductCard from '@/components/Product'; // Make sure this path is correct based on your file structure
...
export default function Product() {
  ...
  return (
    <View style={tw`w-full h-full bg-black`}>
      ...
      {/* Product Items List */}
      <FlatList
        data={ProductData.filter((item) => selectedCategories.length === 0 || selectedCategories.includes(item.category))}
